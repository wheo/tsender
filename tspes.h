...
public:
	...
	void Set(AVFormatContext *s, AVPacket *pkt);
	void Set(es_s *pesi);
	void Update();
...
extern int PutPCR(void *p, uint64_t pcr_base, int pcr_ext, bool isDiscPCR, bool isIDR);
extern int PutPCROnly(void *p, uint64_t pcr_base, int pcr_ext, bool isDiscPCR);
